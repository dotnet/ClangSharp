...
public enum CX_StmtClass
{
    ...
    CX_StmtClass_LastOpenACCAssociatedStmtConstruct = CX_StmtClass_OpenACCAtomicConstruct,
    CX_StmtClass_FirstOpenACCConstructStmt = CX_StmtClass_OpenACCWaitConstruct,
    CX_StmtClass_LastOpenACCConstructStmt = CX_StmtClass_OpenACCAtomicConstruct,
    ...
    CX_StmtClass_FirstOMPCanonicalLoopNestTransformationDirective = CX_StmtClass_OMPUnrollDirective,
    CX_StmtClass_LastOMPCanonicalLoopNestTransformationDirective = CX_StmtClass_OMPInterchangeDirective,
    CX_StmtClass_FirstOMPLoopBasedDirective = CX_StmtClass_OMPTeamsGenericLoopDirective,
    CX_StmtClass_LastOMPLoopBasedDirective = CX_StmtClass_OMPInterchangeDirective,
    ...
    CX_StmtClass_FirstOMPCanonicalLoopSequenceTransformationDirective = CX_StmtClass_OMPFuseDirective,
    CX_StmtClass_LastOMPCanonicalLoopSequenceTransformationDirective = CX_StmtClass_OMPFuseDirective,
    ...
    CX_StmtClass_FirstLoopControlStmt = CX_StmtClass_ContinueStmt,
    CX_StmtClass_LastLoopControlStmt = CX_StmtClass_BreakStmt,
