...
public enum CX_AttrKind
{
    ...
    CX_AttrKind_HLSLAppliedSemantic,
    CX_AttrKind_HLSLParsedSemantic,
    CX_AttrKind_HLSLPackOffset,
    CX_AttrKind_HLSLUnparsedSemantic,
    CX_AttrKind_HLSLVkLocation,
    ...
    CX_AttrKind_ARMInterruptSaveFP,
    CX_AttrKind_ARMSaveFP,
    ...
    CX_AttrKind_FormatMatches,
    CX_AttrKind_FunctionReturnThunks,
    CX_AttrKind_GCCStruct,
    ...
    CX_AttrKind_HLSLVkBinding,
    CX_AttrKind_HLSLVkConstantId,
    CX_AttrKind_HLSLVkExtBuiltinInput,
    CX_AttrKind_HLSLVkPushConstant,
    ...
    CX_AttrKind_OMPGroupPrivateDecl,
    ...
    CX_AttrKind_OpenACCRoutineAnnot,
    CX_AttrKind_OpenACCRoutineDecl,
    ...
    CX_AttrKind_ReentrantCapability,
    ...
    CX_AttrKind_RootSignature,
    CX_AttrKind_SwiftNullability,
    CX_AttrKind_SwiftObjCMembers,
    CX_AttrKind_SwiftType,
    CX_AttrKind_SwiftVersionedAddition,
    CX_AttrKind_SwiftVersionedRemoval,
    CX_AttrKind_Thread,
    CX_AttrKind_FirstAttr = 1,
    CX_AttrKind_LastAttr = 453,
    CX_AttrKind_FirstTypeAttr = 1,
    CX_AttrKind_LastTypeAttr = 45,
    CX_AttrKind_FirstStmtAttr = 46,
    CX_AttrKind_LastStmtAttr = 55,
    CX_AttrKind_FirstDeclOrStmtAttr = 56,
    CX_AttrKind_LastDeclOrStmtAttr = 59,
    CX_AttrKind_FirstInheritableAttr = 56,
    CX_AttrKind_LastInheritableAttr = 420,
    CX_AttrKind_FirstDeclOrTypeAttr = 60,
    CX_AttrKind_LastDeclOrTypeAttr = 92,
    CX_AttrKind_FirstInheritableParamAttr = 93,
    CX_AttrKind_LastInheritableParamAttr = 106,
    CX_AttrKind_FirstInheritableParamOrStmtAttr = 93,
    CX_AttrKind_LastInheritableParamOrStmtAttr = 93,
    CX_AttrKind_FirstParameterABIAttr = 94,
    CX_AttrKind_LastParameterABIAttr = 98,
    CX_AttrKind_FirstHLSLAnnotationAttr = 107,
    CX_AttrKind_LastHLSLAnnotationAttr = 111,
    CX_AttrKind_FirstHLSLSemanticBaseAttr = 107,
    CX_AttrKind_LastHLSLSemanticBaseAttr = 108,
}
