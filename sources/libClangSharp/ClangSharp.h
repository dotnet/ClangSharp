...
CLANGSHARP_LINKAGE CXType clangsharp_Cursor_getType(CXCursor C);
...
CLANGSHARP_LINKAGE CX_TemplateArgument clangsharp_Type_getTemplateArgument(CXCursor C, unsigned i);
