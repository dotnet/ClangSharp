...
public class Stmt : Cursor
{
    ...
    internal static new Stmt Create(CXCursor handle) => handle.StmtClass switch {
        ...
        CX_StmtClass_PackIndexingExpr => new PackIndexingExpr(handle),
        ...
        CX_StmtClass_OpenACCAsteriskSizeExpr => new OpenACCAsteriskSizeExpr(handle),
        ...
        CX_StmtClass_HLSLOutArgExpr => new HLSLOutArgExpr(handle),
        ...
        CX_StmtClass_EmbedExpr => new EmbedExpr(handle),
        ...
        CX_StmtClass_ArraySectionExpr => new ArraySectionExpr(handle),
        ...
        CX_StmtClass_SYCLKernelCallStmt => new SYCLKernelCallStmt(handle),
        ...
        CX_StmtClass_OpenACCWaitConstruct => new OpenACCWaitConstruct(handle),
        CX_StmtClass_OpenACCUpdateConstruct => new OpenACCUpdateConstruct(handle),
        CX_StmtClass_OpenACCShutdownConstruct => new OpenACCShutdownConstruct(handle),
        CX_StmtClass_OpenACCSetConstruct => new OpenACCSetConstruct(handle),
        CX_StmtClass_OpenACCInitConstruct => new OpenACCInitConstruct(handle),
        CX_StmtClass_OpenACCExitDataConstruct => new OpenACCExitDataConstruct(handle),
        CX_StmtClass_OpenACCEnterDataConstruct => new OpenACCEnterDataConstruct(handle),
        CX_StmtClass_OpenACCCacheConstruct => new OpenACCCacheConstruct(handle),
        CX_StmtClass_OpenACCLoopConstruct => new OpenACCLoopConstruct(handle),
        CX_StmtClass_OpenACCHostDataConstruct => new OpenACCHostDataConstruct(handle),
        CX_StmtClass_OpenACCDataConstruct => new OpenACCDataConstruct(handle),
        CX_StmtClass_OpenACCComputeConstruct => new OpenACCComputeConstruct(handle),
        CX_StmtClass_OpenACCCombinedConstruct => new OpenACCCombinedConstruct(handle),
        CX_StmtClass_OpenACCAtomicConstruct => new OpenACCAtomicConstruct(handle),
        ...
        CX_StmtClass_OMPStripeDirective => new OMPStripeDirective(handle),
        CX_StmtClass_OMPReverseDirective => new OMPReverseDirective(handle),
        CX_StmtClass_OMPInterchangeDirective => new OMPInterchangeDirective(handle),
        ...
        CX_StmtClass_OMPAssumeDirective => new OMPAssumeDirective(handle),
