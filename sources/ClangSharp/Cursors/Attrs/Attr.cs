...
public class Attr : Cursor
{
    ...
    internal static new Attr Create(CXCursor handle) => handle.AttrKind switch {
        ...
        CX_AttrKind_CFISalt => new Attr(handle),
        ...
        CX_AttrKind_HLSLIsCounter => new Attr(handle),
        ...
        CX_AttrKind_HLSLAppliedSemantic => new Attr(handle),
        CX_AttrKind_HLSLParsedSemantic => new Attr(handle),
        CX_AttrKind_HLSLPackOffset => new Attr(handle),
        CX_AttrKind_HLSLUnparsedSemantic => new Attr(handle),
        CX_AttrKind_HLSLVkLocation => new Attr(handle),
        ...
        CX_AttrKind_CUDAClusterDims => new Attr(handle),
        ...
        CX_AttrKind_CUDANoCluster => new Attr(handle),
        ...
        CX_AttrKind_DLLExportOnDecl => new Attr(handle),
        ...
        CX_AttrKind_GCCStruct => new Attr(handle),
        ...
        CX_AttrKind_MallocSpan => new Attr(handle),
        ...
        CX_AttrKind_ModularFormat => new Attr(handle),
        ...
        CX_AttrKind_OMPGroupPrivateDecl => new Attr(handle),
        ...
        CX_AttrKind_SYCLExternal => new Attr(handle),
