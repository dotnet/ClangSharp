...
public class Attr : Cursor
{
    ...
    internal static new Attr Create(CXCursor handle) => handle.AttrKind switch {
        ...
        CX_AttrKind.CX_AttrKind_AnnotateType => new TypeAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_OpenCLGlobalDeviceAddressSpace => new TypeAttr(handle),
        CX_AttrKind.CX_AttrKind_OpenCLGlobalHostAddressSpace => new TypeAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_TypeNullableResult => new TypeAttr(handle),
        CX_AttrKind.CX_AttrKind_UPtr => new TypeAttr(handle),
        CX_AttrKind.CX_AttrKind_FallThrough => new StmtAttr(handle),
        CX_AttrKind.CX_AttrKind_Likely => new StmtAttr(handle),
        CX_AttrKind.CX_AttrKind_MustTail => new StmtAttr(handle),
        CX_AttrKind.CX_AttrKind_OpenCLUnrollHint => new StmtAttr(handle),
        CX_AttrKind.CX_AttrKind_Suppress => new StmtAttr(handle),
        CX_AttrKind.CX_AttrKind_Unlikely => new StmtAttr(handle),
        CX_AttrKind.CX_AttrKind_AlwaysInline => new DeclOrStmtAttr(handle),
        CX_AttrKind.CX_AttrKind_NoInline => new DeclOrStmtAttr(handle),
        CX_AttrKind.CX_AttrKind_NoMerge => new DeclOrStmtAttr(handle),
        CX_AttrKind.CX_AttrKind_AArch64SVEPcs => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_AArch64VectorPcs => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_AMDGPUKernelCall => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_SwiftAsyncCall => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_SwiftAsyncContext => new ParameterABIAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_AlignNatural => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_ArmBuiltinAlias => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_CUDADeviceBuiltinSurfaceType => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_CUDADeviceBuiltinTextureType => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_CmseNSEntry => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_FunctionReturnThunks => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_HIPManaged => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_HLSLNumThreads => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_HLSLSV_GroupIndex => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_HLSLShader => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_Leaf => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_M68kInterrupt => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_NSErrorDomain => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_NoProfileFunction => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_NoRandomizeLayout => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_PreferredName => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_RandomizeLayout => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_Retain => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_StandaloneDebug => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_StrictFP => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftAsync => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftAsyncError => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftAsyncName => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftAttr => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftBridge => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftBridgedTypedef => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftError => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftName => new InheritableAttr(handle),
        CX_AttrKind.CX_AttrKind_SwiftNewType => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_UsingIfExists => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_ZeroCallUsedRegs => new InheritableAttr(handle),
        ...
        CX_AttrKind.CX_AttrKind_BuiltinAlias => new Attr(handle),
        CX_AttrKind.CX_AttrKind_CalledOnce => new Attr(handle),
        CX_AttrKind.CX_AttrKind_IFunc => new Attr(handle),
        CX_AttrKind.CX_AttrKind_InitSeg => new Attr(handle),
        CX_AttrKind.CX_AttrKind_LoaderUninitialized => new Attr(handle),
        ...
        CX_AttrKind.CX_AttrKind_ObjCNonRuntimeProtocol => new Attr(handle),
        ...
        CX_AttrKind.CX_AttrKind_SwiftObjCMembers => new Attr(handle),
