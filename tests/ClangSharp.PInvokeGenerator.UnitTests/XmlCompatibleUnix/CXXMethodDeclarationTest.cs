...
<bindings>
  <namespace name=""ClangSharp.Test"">
    ...
    {{
        return Marshal.GetDelegateForFunctionPointer&lt;<delegate>_GetType</delegate>&gt;((IntPtr)(lpVtbl[<vtbl explicit=""False"">2</vtbl>]))(<param special=""thisPtr"">pThis</param>, <param name=""obj"">obj</param>);
    }}</code>
        </body>
      </function>
      <function name=""GetType"" access=""public"" unsafe=""true"">
    ...
    {{
      ...
      <function name=""GetType"" access=""public"" unsafe=""true"">
        ...
        <body>
          <code>fixed (MyStruct* pThis = &amp;this)
    {{
        return Marshal.GetDelegateForFunctionPointer&lt;<delegate>_GetType2</delegate>&gt;((IntPtr)(lpVtbl[<vtbl explicit=""False"">0</vtbl>]))(<param special=""thisPtr"">pThis</param>, <param name=""objA"">objA</param>, <param name=""objB"">objB</param>);
    }}</code>
        </body>
      </function>
    </struct>
