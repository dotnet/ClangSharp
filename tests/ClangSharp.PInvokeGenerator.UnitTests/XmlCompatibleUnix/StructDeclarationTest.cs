  ...
  <namespace name=""ClangSharp.Test"">
    ...
    {{
      ...
      <field name=""buffer2"" access=""public"">
        <type>ref _Anonymous_e__Struct._buffer2_e__FixedBuffer</type>
        <get>
          <code>fixed (_Anonymous_e__Struct* pField = &amp;Anonymous)
    {{
...
";
        ...
        return ValidateGeneratedXmlCompatibleUnixBindingsAsync(inputContents, expectedOutputContents, withAccessSpecifiers: withAccessSpecifiers);
    }
...
";
        ...
        return ValidateGeneratedXmlCompatibleUnixBindingsAsync(InputContents, ExpectedOutputContents, withPackings: withPackings);
    }
