...
public sealed class XmlPreviewUnix_UnionDeclarationTest : UnionDeclarationTest
{
...
";
        return ValidateGeneratedXmlPreviewUnixBindingsAsync(inputContents, expectedOutputContents, commandlineArgs: Array.Empty<string>());
    }
