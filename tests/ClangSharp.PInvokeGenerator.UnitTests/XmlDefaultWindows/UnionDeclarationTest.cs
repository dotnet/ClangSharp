...
public sealed class XmlDefaultWindows_UnionDeclarationTest : UnionDeclarationTest
{
...
";
        return ValidateGeneratedXmlDefaultWindowsBindingsAsync(inputContents, expectedOutputContents, commandlineArgs: Array.Empty<string>());
    }
...
<bindings>
  <namespace name=""ClangSharp.Test"">
    <struct name=""MyUnion1"" access=""public"" layout=""Explicit""{expectedPack}>
      ...
      <field name=""_bitfield3"" access=""public"" offset=""0"">
        <type>byte</type>
      </field>
      ...
      <field name=""_bitfield4"" access=""public"" offset=""0"">
        <type>int</type>
      </field>
...
";
    ...
    protected override Task ExcludeTestImpl()
    {
        ...
        return ValidateGeneratedXmlDefaultWindowsBindingsAsync(inputContents, expectedOutputContents, excludedNames: excludedNames);
    }
