  ...
  <namespace name=""ClangSharp.Test"">
    <struct name=""MyStruct"" access=""public"" vtbl=""true"" unsafe=""true"">
      ...
      <function name=""GetType"" access=""public"" unsafe=""true"">
        ...
        <body>
          <code>return Marshal.GetDelegateForFunctionPointer&lt;<delegate>_GetType</delegate>&gt;((IntPtr)(lpVtbl[<vtbl explicit=""False"">0</vtbl>]))(<param special=""thisPtr"">(MyStruct*)Unsafe.AsPointer(ref this)</param>, <param name=""obj"">obj</param>);</code>
        </body>
      </function>
      <function name=""GetType"" access=""public"" unsafe=""true"">
        <type>int</type>
        <body>
          <code>return Marshal.GetDelegateForFunctionPointer&lt;<delegate>_GetType1</delegate>&gt;((IntPtr)(lpVtbl[<vtbl explicit=""False"">1</vtbl>]))(<param special=""thisPtr"">(MyStruct*)Unsafe.AsPointer(ref this)</param>);</code>
        </body>
      </function>
      <function name=""GetType"" access=""public"" unsafe=""true"">
        <type>int</type>
        ...
        <body>
          <code>return Marshal.GetDelegateForFunctionPointer&lt;<delegate>_GetType2</delegate>&gt;((IntPtr)(lpVtbl[<vtbl explicit=""False"">2</vtbl>]))(<param special=""thisPtr"">(MyStruct*)Unsafe.AsPointer(ref this)</param>, <param name=""objA"">objA</param>, <param name=""objB"">objB</param>);</code>
        </body>
      </function>
    </struct>
  </namespace>
